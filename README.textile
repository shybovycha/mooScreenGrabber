...
Now, when you've finished recording your screen, you've got a lot of __screen_***.png__ files at your working directory. You can convert them to a one video file using *ffmpeg* (or *avconv* - ffmpeg's developers say *ffmpeg is deprecated*):
